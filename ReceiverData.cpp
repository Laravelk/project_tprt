...
namespace processing {
    ReceiverData::ReceiverData(unsigned int samples_number, unsigned int components_number, const float *values) :
    ...
    void ReceiverData::changePolarity() {
        data *= -1;
    }

    unsigned int ReceiverData::getSamplesNumber() const {
